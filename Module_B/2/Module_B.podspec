...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModuleProjectOrg/Module_B"
  ...
  s.source       = { :git => "https://github.com/ModuleProjectOrg/Module_B.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Module_B/Module_B/**/*.{h,m,swift}"
