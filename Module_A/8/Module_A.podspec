...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModuleProjectOrg/Module_A"
  ...
  s.source       = { :git => "https://github.com/ModuleProjectOrg/Module_A.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Module_A/Module_A/**/*.{h,m,swift}"
